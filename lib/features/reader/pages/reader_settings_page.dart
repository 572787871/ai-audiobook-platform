...
class _ReaderSettingsPageState extends State<ReaderSettingsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    // 第一阶段：仅开放 slide 一种翻页方式；其余入口（cover/scroll/none/curl）
    // 暂隐藏，源码保留，待 slide 真机稳定后逐个恢复。
    final animations = const [PageAnimation.slide];
          ...
          children: [
            Row(
              children: [
                ...
                CupertinoButton(
                  onPressed: () => _update(
                    _s.copyWith(fontSize: (_s.fontSize - 1).clamp(12, 36)),
                  ),
              ...
              children: [
                ...
                Expanded(
                  child: CupertinoSlider(
                    ...
                    divisions: 4,
                    onChanged: (v) =>
                        _update(_s.copyWith(fontWeight: v.round())),
                  ),
                ),
              ],
            ),
