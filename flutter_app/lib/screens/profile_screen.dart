            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                  colors: isPro
                      ...
                      : [
                          AppTheme.primaryLight..withValues(alpha: HOLDER__0.8),
                          AppTheme.accent..withValues(alpha: HOLDER__0.6)
                        ],
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      color: Colors.white..withValues(alpha: HOLDER__0.3),
                ...
                Text(email,
                    style: TextStyle(
                        fontSize: 13,
                        color: Colors.white..withValues(alpha: HOLDER__0.8))),
                const SizedBox(height: 12),
                if (isPro)
                  Container(
                      ...
                      decoration: BoxDecoration(
                          color: Colors.white..withValues(alpha: HOLDER__0.2),
                          borderRadius:
                  ...
                  Container(
                      padding: const EdgeInsets.symmetric(
                          horizontal: 12, vertical: 4),
                      decoration: BoxDecoration(
                          color: Colors.white..withValues(alpha: HOLDER__0.15),
                          borderRadius:
                              BorderRadius.circular(AppTheme.radiusFull)),
              ...
              return Column(children: [
                ...
                if (i < items.length - 1)
                  Padding(
                      ...
                      child: Divider(
                          height: 1,
                          color: cs.onSurface..withValues(alpha: HOLDER__0.06))),
              ]);
            }).toList()),
          ),
        ]));
      ...
      child: Padding(
        ...
        child: Row(children: [
          ...
          if (item.value != null)
            Text(item.value!,
                style: TextStyle(
                    fontSize: 13, color: cs.onSurface..withValues(alpha: HOLDER__0.4))),
          const SizedBox(width: 8),
          Icon(Icons.chevron_right,
              size: 20, color: cs.onSurface..withValues(alpha: HOLDER__0.2)),
        ]),
      ),
    );
  }
