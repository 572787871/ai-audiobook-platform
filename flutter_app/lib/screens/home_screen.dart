          ...
          Container(
            ...
            child: IconButton(
              icon: Icon(Icons.notifications_outlined,
                  color: cs.onSurface..withValues(alpha: HOLDER__0.6), size: 22),
              onPressed: () {
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            Icon(Icons.search,
                color: cs.onSurface..withValues(alpha: HOLDER__0.3), size: 20),
            const SizedBox(width: 10),
            Text("搜索有声书...",
                style: TextStyle(
                    color: cs.onSurface..withValues(alpha: HOLDER__0.35), fontSize: 14)),
            const Spacer(),
            Icon(Icons.mic_outlined,
                color: cs.onSurface..withValues(alpha: HOLDER__0.2), size: 20),
            const SizedBox(width: 16),
          ],
        ),
      ),
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                  color: cs.primary..withValues(alpha: HOLDER__0.1), width: 0.5),
            ),
          ...
          Text(a.label,
              style: TextStyle(
                  ...
                  color: cs.onSurface..withValues(alpha: HOLDER__0.7))),
        ],
      ),
    );
  }
