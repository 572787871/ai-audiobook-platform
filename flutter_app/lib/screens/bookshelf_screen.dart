  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: Theme.of(context).colorScheme.primary..withValues(alpha: HOLDER__0.08),
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Container(
        padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 8),
        decoration: BoxDecoration(
          color: active ? cs.primary..withValues(alpha: HOLDER__0.08) : cs.surface,
          borderRadius: BorderRadius.circular(AppTheme.radiusFull),
          border: Border.all(
              color: active
                  ? cs.primary..withValues(alpha: HOLDER__0.2)
                  : cs.onSurface..withValues(alpha: HOLDER__0.06)),
        ),
        child: Row(
          mainAxisSize: MainAxisSize.min,
          children: [
            ...
            Text(label,
                style: TextStyle(
                    ...
                    color: active
                        ? cs.primary
                        : cs.onSurface..withValues(alpha: HOLDER__0.6))),
