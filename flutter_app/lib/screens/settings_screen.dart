  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView(padding: const EdgeInsets.all(24), children: [
        ...
        ListTile(title: const Text("跟随系统"), leading: Radio(value: ThemeMode.system, groupValue: _themeMode, onChanged: (v) => setState(() => _themeMode = v!))),
        ListTile(title: const Text("浅色"), leading: Radio(value: ThemeMode.light, groupValue: _themeMode, onChanged: (v) => setState(() => _themeMode = v!))),
        ListTile(title: const Text("深色"), leading: Radio(value: ThemeMode.dark, groupValue: _themeMode, onChanged: (v) => setState(() => _themeMode = v!))),
        const SizedBox(height: 24),
